...
func generateToken(userID int64, ttl time.Duration, scope string) (*Token, error) {
	...
	// Create a Token instance containing the user ID, expiry and scope infn
	// Notice that we add the provided ttl duration para to the current time
	...
	// random bytes from your OS CSPRNG. This will return an error if
...
// Define the TokenModel
type TokenModel struct {
	DB *sql.DB
}

// The New() method is a shortcut which creates a new Token struct and then inserts a
